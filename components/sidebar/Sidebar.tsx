...
export default function Sidebar() {
	return (
		<aside className="w-78 min-h-screen flex flex-col p-0 pb-8 border-r border-sidebar-border text-texto-branco bg-linear-to-b from-sidebar-start to-sidebar-end">
			<div className="flex items-center gap-4 px-6 pt-8 pb-6 border-b border-sidebar-borda">
				<div className="bg-bg-card p-1 rounded-md">
					<Image src="/images/uniso.png" alt="Uniso Flow Logo" width={40} height={40} />
				</div>
				<div>
					<div className="text-lg text-texto-branco">Uniso Flow</div>
					<div className="text-sm text-sidebar-texto-secundario">Gestão Acadêmica</div>
				</div>
			</div>
